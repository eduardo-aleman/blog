---
title: "Rapsodia para el mulo"
date: '2026-01-02'
summary: Texto completo de «Rapsodia para el mulo», uno de los poemas más complejos, profundos y celebrados del escritor cubano José Lezama Lima, publicado originalmente en su libro Aventuras sigilosas (1945).
description: Texto completo de «Rapsodia para el mulo», uno de los poemas más complejos, profundos y celebrados del escritor cubano José Lezama Lima, publicado originalmente en su libro Aventuras sigilosas (1945).
categories:
- Poesía
draft: false
type: posts
...
image_alt: "«Rapsodia para el mulo» es un ejemplo supremo del sistema poético barroco (o neobarroco americano) que José Lezama Lima consolidó a lo largo de su carrera. En la cosmovisión del autor cubano, el barroco no es un simple ornamento o un estilo recargado, sino un método de conocimiento y una herramienta metafísica para rellenar el vacío histórico americano mediante la acumulación, la hibridación y el mito."
---
